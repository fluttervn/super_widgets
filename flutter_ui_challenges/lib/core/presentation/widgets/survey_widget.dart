            ...
            child: Column(
              ...
              children: <Widget>[
                ...
                ...survey.options.map((option) => RadioListTile(
                      ...
                      onChanged: (val) {
                        FirestoreService()
                            .updateDocument('surveys', survey.id, {
                          val: FieldValue.increment(1),
                        });
                        AuthFirestoreService().updateUserData(
                            Provider.of<UserRepository>(context).user.uid, {
                          "surveys": FieldValue.arrayUnion([survey.id])
                        });
                        Scaffold.of(context).showSnackBar(SnackBar(
                            content:
                                Text("Thank you for providing us feedback")));
                      },
                    ))
              ],
            ),
